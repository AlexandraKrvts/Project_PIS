...
namespace Dekanat.WEB.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult StudentGroupSearch(string nam)
        {
            List<StudentDTO> studDtos = studentService.SearchByGroup(nam);
            var mapper = new MapperConfiguration(cfg => cfg.CreateMap<StudentDTO, StudentViewModel>()).CreateMapper();
            var newgr = mapper.Map<List<StudentDTO>, List<StudentViewModel>>(studDtos);
